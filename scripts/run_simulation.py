...
def run_simulation(input_params, concentration_vector, simulation_geometry,
                   free_en, equations, out_directory):
    ...
    while (elapsed <= duration) and (step <= total_steps):
        ...
        if time_profile_flag:
            ...
            if elapsed > input_params['time_profile'][transition_counter]['transition_time']:
                ...
                boundary_conditions = simulation_helper.set_boundary_conditions(input_params=input_parameters,
                ...
                equations = simulation_helper.set_model_equations(input_params=input_params,
                                                                  ...
                                                                  simulation_geometry=simulation_geometry)
                # Update the numerical simulation parameters
                dt = input_params['dt']
                dt_max = input_params['dt_max']
                dt_min = input_params['dt_min']
                max_sweeps = int(input_params['max_sweeps'])
...
if __name__ == "__main__":
    ...
    boundary_condition = simulation_helper.set_boundary_conditions(input_params=input_parameters,
                                                                   simulation_geometry=sim_geometry)
    print('Successfully set up boundary conditions ...')
